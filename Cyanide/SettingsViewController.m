...
- (NSArray<NSDictionary *> *)nanoRegistryRows
{
    return @[
        @{ @"kind": @"stepper",
           ...
           @"title": @"watchOS 配对上限",
           @"subtitle": @"调整本 iPhone 可接受的最高 watchOS 配对通信协议版本，以兼容更新的 watchOS 版本。 [范围：99] ",
           @"min": @(kNanoUIRowMin),
           @"max": @(kNanoUIRowMax),
        ...
        @{ @"kind": @"stepper",
           ...
           @"title": @"设置协议下限",
           @"subtitle": @"调整本 iPhone 可接受的最低配对通信协议版本，以确保配对消息不被拒绝。[范围：23]",
           @"min": @(kNanoUIRowMin),
           @"max": @(kNanoUIRowMax),
        ...
        @{ @"kind": @"stepper",
           ...
           @"title": @"旧芯片下限",
           @"subtitle": @"除非你要配对的是老款 S 芯片手表（如 Series 3），否则请保持此设置不变。[范围：10]",
           @"min": @(kNanoUIRowMin),
           @"max": @(kNanoUIRowMax),
